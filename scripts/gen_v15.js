...
slide1.addText("数据来源：官方发布 + 972家展商样本交叉验证", {
...
addFooter(slide2, "数据来源：第27届上海国际环博会官方发布（2026.04.15）；样本校验：微信公众号「城市中国」「环保开幕」OCR识别972家展商");
...
addSlideHeader(slide3, "02", "展馆分布：行业全景地图（官方版）", "数据来源：官方展馆数据 + 公众号样本972家 + 行业媒体交叉验证（仪器信息网/化工仪器网/分析测试百科网）");
addFooter(slide3, "E4/E6/E5/E2/E1数据来源：官方发布；E3馆已确认16家展商含展位号，来自仪器信息网/化工仪器网/分析测试百科网/环境商会等多源交叉验证");

const halls = [
  { hall: "E4馆", count: "182家", theme: "过程控制/仪器仪表", insight: "仪器仪表最集中，同行竞争最激烈", official: true },
  { hall: "E6馆", count: "187家", theme: "大气治理/余热回收", insight: "规模最大，细分领域覆盖最广", official: true },
  { hall: "E5馆", count: "174家", theme: "大气治理/VOCs", insight: "VOC治理、无组织排放管控热点", official: true },
  { hall: "E2馆", count: "120家", theme: "综合环境解决方案", insight: "工程/运营/咨询类展商最多", official: true },
  { hall: "E1馆", count: "93家", theme: "水处理/膜材料/泵阀", insight: "膜材料国产化、价格下探明显", official: true },
  { hall: "E3馆", count: "16家*", theme: "监测与检测", insight: "哈希(C12★)、聚光/谱育(★双奖)、智易时代(D19/C20★机器人奖)、格林凯瑞(B42)、诺方(B79)、深昌鸿(E75)、淳业(C98)、雷磁(D22)、迪特西(C39)、沃德精准(E3L-20)、莱特莱德(A38)、虹润、皖仪、源易测、国林科技、纽带智能(G61)", official: false },
];
halls.forEach((h, i) => {
  const col = i % 3;
  ...
  slide3.addShape(pres.shapes.RECTANGLE, {
    ...
    fill: { color: WHITE },
    line: { color: h.official ? (i === 0 ? BLUE : LTGRAY) : LTGRAY, width: h.official ? 1.5 : 0.75 }
  });

  // Hall name badge
  slide3.addShape(pres.shapes.RECTANGLE, {
    x: x, y: y, w: 0.7, h: 0.35,
    fill: { color: h.official ? BLUE : LTGRAY }
  });
  ...
  slide3.addText(h.count, {
    ...
    color: h.official ? DKGRAY : LTGRAY, valign: "middle"
  });
...
// E3 note
slide3.addText("* E3馆已确认16家展商含展位号，来自仪器信息网/化工仪器网/分析测试百科网/环境商会/生物器材网等多源交叉验证；★=2026 IE环博奖得主；官方展商目录未公开，实际更多；展馆主题：监测与检测", {
...
const forces = [
  {
    ...
    score: "高",
    color: "C0392B",
    detail: "E4馆182家仪器仪表扎堆；价格战已从设备蔓延到耗材（膜价格低40-60%）；纯硬件模式越来越难",
    evidence: "★★★ 展商分布数据"
  },
  {
    title: "新进入者威胁",
    score: "中高",
    color: "E67E22",
    detail: "39家数字化公司跨界切入（云平台+数据+IoT）；软件能力强的跨界者正在重新定义竞争规则",
    evidence: "★★★ 展商分类数据"
  },
  {
    title: "上游议价能力",
    score: "中",
    color: "F39C12",
    detail: "传感器/芯片国产化提升，但高端传感器仍依赖进口；传感器价格下探有助于降低仪表成本",
    evidence: "★★ 行业趋势推断"
  },
  {
    title: "下游议价能力",
    score: "高",
    color: "C0392B",
    detail: "水务集团/市政采购：政府招标、国产优先、性价比要求高；买方高度集中且信息化程度提升",
    evidence: "★★★ 政策导向+采购模式"
  },
  {
    title: "替代品威胁",
    score: "中",
    color: "7F8C8D",
    detail: "在线监测替代传统实验室抽样（趋势明确）；但高端检测仍需实验室，替代速度中等",
    evidence: "★★ 技术趋势推断"
  },
];
...
addSlideHeader(slide5, "04", "行业价值链：从研发到服务的利润迁移", "数据来源：基于972家展商类型分布推断");
...
// 3 columns: Company / Competitors / Customers
const c3 = [
  {
    title: "Company\n我们",
    color: BLUE,
...
const pestel = [
  {
    letter: "P", name: "政治/Policy", color: BLUE,
    items: [
      { t: "十五五规划开局", d: "美丽中国建设部署，县镇级监测能力建设带来增量市场，黑臭水体治理持续，监测点位加密", source: "官方政策文件" },
      { t: "政府招标国产优先", d: "国产化率要求提升，外资品牌进入采购名单门槛提高", source: "行业政策趋势" },
    ]
  },
  {
    letter: "E", name: "经济/Economic", color: DKGRAY,
    items: [
      { t: "双碳目标推进", d: "碳市场扩容提速，钢铁/化工/水泥/航空等高排放行业分批纳入，碳监测成新增量赛道", source: "官方政策" },
      { t: "水务集团降本增效", d: "地方财政压力下，水务集团降本需求强烈，价格敏感度提升", source: "市场趋势" },
    ]
  },
  {
    letter: "S", name: "社会/Social", color: LTGRAY,
    items: [
      { t: "公众环保意识提升", d: "环境数据公开需求增加，舆情监督倒逼企业监测升级", source: "社会趋势" },
      { t: "监测从业人员结构变化", d: "数字化技能需求增加，传统运维人员面临转型压力", source: "行业观察" },
    ]
  },
  {
    letter: "T", name: "技术/Technological", color: BLUE,
    items: [
      { t: "AI+IoT加速融合", d: "数字孪生、预测性维护、异常预警技术成熟度提升，从概念走向落地", source: "展商技术展示" },
      { t: "5G模组成本下降", d: "5G+工业互联网预计2027年进入爆发期", source: "行业预测" },
    ]
  },
  {
    letter: "E", name: "环境/Environmental", color: DKGRAY,
    items: [
      { t: "水环境精细化管理", d: "流域监测、断面监测加密，饮用水源监测需求增加", source: "政策文件" },
      { t: "大气治理持续高压", d: "VOC无组织排放管控趋严，监测密度要求提升", source: "政策文件" },
    ]
  },
  {
    letter: "L", name: "法律/Legal", color: LTGRAY,
    items: [
      { t: "等保2.0+数据安全法", d: "数据联网合规要求筛掉大批中小平台厂商，利好头部", source: "法规要求" },
      { t: "碳核查法制化", d: "碳排放数据真实性要求提高，第三方监测市场扩容", source: "政策趋势" },
    ]
  },
];
...
addSlideHeader(slide8, "07", "技术趋势TOP5：这次展会上什么最火", "数据来源：展商样本972家分析 + 官方展会主题");
addFooter(slide8, "数据来源：公众号展商目录样本分析；推断结论标注置信度");

const techTrends = [
  { num: "①", title: "在线监测设备爆发", conf: "★★★",
    detail: "E4馆182家展商中超40%展示在线监测产品，24/7实时监测替代传统实验室抽样已成明确趋势。云+端一体化是活下去的基本要求。",
    source: "展商样本数据" },
  { num: "②", title: "传感器小型化与IoT化", conf: "★★",
    detail: "多款小型化水质传感器、光谱分析仪亮相，支持自适应采集、边缘预处理、分布式部署。农业面源污染、河道监测等新场景涌现。",
    source: "展商展示推断" },
  { num: "③", title: "AI与大数据分析落地", conf: "★★",
    detail: "预测性维护、异常预警、排放趋势预测是主要AI落地场景。异常检测>趋势预测>溯源分析，技术成熟度依次递减。",
    source: "展商展示+行业观察" },
  { num: "④", title: "数字孪生从概念走向落地", conf: "★★",
    detail: "多个展台展示三维水厂、智慧水务大屏，但落地成本高，目前主要集中在大型水务集团和工业园区。",
    source: "展商展示推断" },
  { num: "⑤", title: "5G+工业互联网", conf: "★",
    detail: "5G网关、5G+监测方案首次大规模亮相，低延时特性支撑实时控制和远程运维。预计2027年进入爆发期。",
    source: "行业预测" },
];
...
techTrends.forEach((t, i) => {
  ...
  slide8.addShape(pres.shapes.RECTANGLE, {
    x: 1.05, y: y + 0.38, w: 0.4, h: 0.28,
    fill: { color: t.conf === "★★★" ? BLUE : t.conf === "★★" ? DKGRAY : LTGRAY }
  });
  slide8.addText(t.conf, {
    x: 1.05, y: y + 0.38, w: 0.4, h: 0.28,
    fontSize: 9, fontFace: "Microsoft YaHei",
...
addSlideHeader(slide9, "08", "AI分论坛核心结论：政府AI体系已成型，监测数据进入AI分析链", "数据来源：2026中国环境技术大会AI×环保论坛（4月13-14日，环博会同期）；腾讯元宝会议纪要");
...
const aiScenarios = [
  {
    n: "①", title: "污染源数据异常智能诊断",
    tech: "4个AI专家智能体协同：数据预处理/诊断分析/结果解读/可视化",
    result: "6类异常自动识别（数据缺失、高值突增、低值骤降等）",
    color: BLUE
  },
  {
    n: "②", title: "湖库/河道AI智能识别",
    tech: "多模态：无人机航拍+固定摄像头+卫星遥感；YOLOv8+大模型",
    result: "某市河道违规行为识别准确率90%+；自动告警",
    color: DKGRAY
  },
  {
    n: "③", title: "污染溯源报告一键生成",
    tech: "环境知识库+全域溯源知识图谱+大模型",
    result: "自动生成：事件概况+溯源分析+处置建议",
    color: LTGRAY
  },
];
...
addFooter(slide9, "数据来源：2026中国环境技术大会AI×环保论坛（4月13-14日，上海）；腾讯元宝会议纪要（ada69a26-45e4-4b8c-b92c-29e204aceeb4）");
...
const customers = [
  {
    ...
    need: "从买设备→买平台→买服务",
    pain: "厂网河湖一体化监测、智慧水务大屏、数据联网",
    decision: "政府招标\n国产优先",
    color: BLUE
  },
  {
    type: "工业园区/企业", scale: "中型项目\n50-300万",
    need: "满足监管→降本增效→数据资产化",
    pain: "在线监测系统、碳核查、排放数据上报",
    decision: "企业自采\n价格敏感",
    color: DKGRAY
  },
  {
...
const threats = [
  { level: "极高威胁", companies: "江苏纽带智能(E3-G61)\nE20环境平台(E1-C71)", desc: "平台型：端到端智能监测，传感器+云平台+运维一体化；E3馆监测厂商已确认16家，平台型竞争加剧", color: "C0392B" },
  { level: "高威胁", companies: "尚云互联、易环智能\n盘古自动化、智易时代", desc: "垂直型：智慧环保平台、自动化控制+AI算法；智易时代已获AI巡检机器人创新奖；平台+硬件整合趋势明显", color: "E67E22" },
  { level: "中威胁", companies: "云景信息、崟盾智能\n缘循智能 等33家", desc: "细分型：智慧水务平台、流体控制智能化等垂直场景，绑定特定客户群体；技术代差在拉大", color: "F39C12" },
];
...
const consensus = [
  { n: "1", title: "产品：监测设备向实时化、智能化演进",
    fact: "E4馆182家仪器仪表展商中超40%展示在线监测产品，IoT版本已成标配",
   共鸣: "纯卖硬件越来越难，云+端一体化是活下去的基本要求" },
  { n: "2", title: "技术：云+AI是技术主线，但落地节奏差异大",
    fact: "39家数字化展商中70%提供云服务，AI异常检测是主要落地场景",
   共鸣: "大水务在数字孪生，小水厂还在搞定标——技术代差在拉大" },
  { n: "3", title: "客户：买服务不买设备已成普遍现实",
    fact: "展商普遍推出年度运维服务合同，政府招标将服务能力纳入评分",
   共鸣: "一次性采购的饼越来越小，维保服务的钱越来越重要" },
  { n: "4", title: "政策：十五五+双碳构成双重引擎",
    fact: "美丽中国建设+碳市场扩容，政策文件可直接引用，市场测算有据可查",
   共鸣: "政策红利还在，但竞争者也在增多，能不能吃到看能力和资源" },
  { n: "5", title: "格局：跨界打劫正在发生，但还未颠覆",
    fact: "39家数字化跨界公司以平台+数据能力切入，但硬件根基不稳",
   共鸣: "传统仪表厂商不要慌，但必须加速软件能力建设，否则会被跨进来" },
];
...
const sources = [
  { cat: "官方数据", items: ["第27届上海国际环博会官方发布（2026.04.15）：1,987家展商、82,419名观众、17万平米、15馆", "官方展会主题：百国共襄 智能引领", "下一届：第28届上海环博会 2027年4月20-22日"] },
  { cat: "展商数据", items: ["主数据源：微信公众号「城市中国」展商目录文章，OCR识别约590家（E1/E2/E4/E5/E6馆）", "E3馆专项数据：仪器信息网、化工仪器网、分析测试百科网、环境商会、生物器材网等多源交叉验证，已确认16家展商含展位号", "数字化公司筛选：同时包含云/平台/数据/智能/数字关键词，共计39家"] },
  { cat: "政策数据", items: ["十五五规划纲要（2026年启动）— 美丽中国建设部署", "全国两会政府工作报告2026", "生态环境部公开文件"] },
  { cat: "E3馆展商来源", items: ["仪器信息网：哈希(★年度领军)、聚光/谱育(★双奖)、格林凯瑞(B42)、雷磁(D22)、虹润、皖仪(★成长先锋)、迪特西(C39)", "化工仪器网：深昌鸿(E3-E75)、格林凯瑞(B42)、诺方(B79)", "分析测试百科网/环境商会：淳业科技(C98)、源易测、国林科技、沃德精准(E3L-20)、莱特莱德(A38)", "★=2026 IE环博奖得主；展位号均来自行业媒体报道"] },
  { cat: "论坛数据", items: ["2026中国环境技术大会AI×环保论坛（4月13-14日，上海），腾讯元宝会议纪要（ID: ada69a26-45e4-4b8c-b92c-29e204aceeb4）", "演讲嘉宾：生态环境部技术专家、赵总（水环境AI）、陈荣研究员（AI驱动环境监管数字化）、高松教授（VOC与大气AI感知）"] },
];
...
// ==================== SAVE ====================
pres.writeFile({ fileName: "/home/agentuser/环博会市场观察_v15.pptx" })
  .then(() => console.log("Done: /home/agentuser/环博会市场观察_v15.pptx"))
