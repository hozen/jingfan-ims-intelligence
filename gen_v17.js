...
halls.forEach((h, i) => {
  ...
  slide3.addText(h.count, {
    ...
    fontSize: h.count.length > 10 ? 10 : 18,
...
const forces = [
  { title: "行业内现有竞争", score: "高", color: "C0392B", detail: "E4馆182家仪器仪表扎堆；价格战已从设备蔓延到耗材（膜价格低40-60%）；纯硬件模式越来越难", evidence: "★★★ 展商分布" },
  { title: "新进入者威胁", score: "中高", color: "E67E22", detail: "39家数字化公司跨界切入（云平台+数据+IoT）；软件能力强的跨界者正在重新定义竞争规则", evidence: "★★★ 展商分类" },
  { title: "上游议价能力", score: "中", color: "F39C12", detail: "传感器/芯片国产化提升，但高端传感器仍依赖进口；传感器价格下探有助于降低仪表成本", evidence: "★★ 行业趋势" },
  { title: "下游议价能力", score: "高", color: "C0392B", detail: "水务集团/市政采购：政府招标、国产优先、性价比要求高；买方高度集中且信息化程度提升", evidence: "★★★ 政策+采购" },
  { title: "替代品威胁", score: "中", color: "7F8C8D", detail: "在线监测替代传统实验室抽样（趋势明确）；但高端检测仍需实验室，替代速度中等", evidence: "★★ 技术趋势" },
];
...
forces.forEach((f, i) => {
  ...
  slide4.addText(f.detail, {
    x: 3.6, y: y, w: 5.0, h: 0.6,
    fontSize: 11, fontFace: "Microsoft YaHei",
    color: DKGRAY, valign: "middle"
  });

  slide4.addText(f.evidence, {
    x: 8.65, y: y, w: 1.2, h: 0.6,
...
const c3 = [
  ...
  },
  {
    ...
    items: [
      ...
      { t: "国际品牌", d: "赛莱默(Xylem)：E1馆，POM+臭氧新品；威立雅：E1馆人形机器人+AI降碳；恩德斯豪斯(EH)：全球客户论坛在瑞士，环博会未见大动作", ev: "★★★" },
    ]
  },
  {
    title: "Customers\n客户",
    ...
    items: [
      ...
      { t: "政府/监管机构", d: "一张网+精准溯源；等保合规；区域型项目1000万+", ev: "★★" },
...
const threats = [
  { level: "极高威胁", companies: "江苏纽带智能(E3-G61)\nE20环境平台(E1)", desc: "平台型：端到端智能监测，传感器+云平台+运维一体化", color: "C0392B" },
...
// ==================== SAVE ====================
pres.writeFile({ fileName: "/home/agentuser/环博会市场观察_v17.pptx" })
  .then(() => console.log("Done: /home/agentuser/环博会市场观察_v17.pptx"))
